...
public class DomitoryDao {
	...
	public void Add(DomitoryBean cnbean){
		...
		sql+="Domitory_BuildingID,Domitory_Name,Domitory_Type,Domitory_Number";
		sql+=") values(";
		sql+="'"+cnbean.getDomitory_BuildingID()+"','"+cnbean.getDomitory_Name()+"','"+cnbean.getDomitory_Type()+"','"+cnbean.getDomitory_Number()+"'";
		sql+=")";
		Statement stat = null;
		ResultSet rs = null;
		Connection conn = new DBHelper().getConn();
