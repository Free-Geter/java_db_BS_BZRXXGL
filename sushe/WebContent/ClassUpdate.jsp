      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="ClassUpdateSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="33%" height="30" align="right">&nbsp;</td>
                    <td width="67%"><input name="Class_ID" type="text" class="noshow" id="Class_ID" value="<s:property value='cnbean.Class_ID'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>班级名：</td>
                    <td><input name="Class_Name" type="text" class="text2" id="Class_Name" value="<s:property value='cnbean.Class_Name'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>专业：</td>
                    <td><input name="Class_Dept" type="text" class="text2" id="Class_Dept" value="<s:property value='cnbean.Class_Dept'/>"></td>
                  </tr>
                 <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>班级人数：</td>
                    <td><input name="Class_Number" type="text" class="text2" id="Class_Number" value="<s:property value='cnbean.Class_Number'/>"></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><select name="Class_Back" id="Class_Back">
                      <option value="">请选择</option>
                      <option value="本科" 
                      <s:if test='cnbean.Class_Back=="本科"'>selected</s:if>
                      >本科
                      </option>
                      <option value="研究生" 
                      <s:if test='cnbean.Teacher_Sex=="研究生"'>selected</s:if>
                      >研究生
                      </option>
