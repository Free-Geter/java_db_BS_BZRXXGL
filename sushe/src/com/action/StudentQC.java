...
public class StudentQC extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		//查询是否存在
		List<StudentBean> list=new StudentDao().GetList("Student_Username='"+Student_Username+"' and Student_State='在读，已入住'", "");
		if(list.size()<1)
		{
			out.print("<script language='javascript'>alert('学号不存在，或学生不处于“就读“状态！');history.back(-1);</script>");
			out.flush();out.close();return null;
		}
