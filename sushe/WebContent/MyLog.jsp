          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
				...
				<table width=100%>
				<tr>
				<td width=50% height="30" align="center" style="color:red;">楼宇</td>
				</tr>
				...
				<table width=100% >
				<tr>
				<td width=50% height="30" align="center" style="color:red;">班级</td>
				</tr>
				 <s:iterator id="bb" value="list2">
                  <tr>
                    <td height="30" align="center">
                      <a href="MyLogList2.action?Class_ID=${TC_ClassID}">${Class_Name}</a>
                    </td>
                  </tr>
                  </s:iterator>
				</table>
