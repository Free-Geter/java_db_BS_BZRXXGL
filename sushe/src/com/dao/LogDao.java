...
public class LogDao {
	...
	public List<LogBean> GetList(String strwhere,String strorder){
		//String sql
		String sql="select * from Log,Student,Domitory,Building,Class where Student_ClassID=Class_ID and Student_DomitoryID=Domitory_ID and Domitory_BuildingID=Building_ID and Log_StudentID=Student_ID ";
...
//		System.out.println(sql);
	...
	public LogBean GetBean(int id){
		String sql="select * from Log,Teacher,Student,Domitory,Building,Class where Student_ClassID=Class_ID and Log_TeacherID=TeacherID and Log_StudentID=Student_ID and Student_DomitoryID=Domitory_ID and Domitory_BuildingID=Building_ID and Log_ID="+id;
		Statement stat = null;
		ResultSet rs = null;
		Connection conn = new DBHelper().getConn();
		LogBean cnbean=new LogBean();
	...
	public void Add(LogBean cnbean){
		...
		sql+="Log_StudentID,Log_Date,Log_Remark";
		sql+=") values(";
		sql+="'"+cnbean.getLog_StudentID()+"','"+cnbean.getLog_Date()+"','"+cnbean.getLog_Remark()+"'";
		sql+=")";
		Statement stat = null;
		ResultSet rs = null;
		Connection conn = new DBHelper().getConn();
