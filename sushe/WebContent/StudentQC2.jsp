            ...
            <tr>
              ...
              <form name="form1" method="post" action="StudentQCSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="30" colspan="2" align="center" style="color:red;">此功能用于学生毕业处理，毕业后将不可恢复！ 确定要调整学生状态吗？</td>
                    </tr>
                  <tr>
                  ...
                  <tr>
                    <td width="33%" height="30" align="right">目前班级：</td>
                    <td width="67%"><s:property value='cnbean.Domitory_Name'/></td>
                  </tr>
                  <tr>
                    <td height="30" align="right">毕业备注：</td>
                  ...
                  <tr>
                    ...
                    <td><input type="submit" name="button" id="button" value="确定毕业">
                      &nbsp;&nbsp;
