      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">班主任信息管理</td>
            </tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="ClassManager.action">
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="28%" height="30" style="padding-left:20px;"> 功能导航： <a href="ClassAdd.action">添加班级</a></td>
                    <td width="72%">查询：
                      <select name="SearchRow" id="SearchRow">
                      	<option value="">请选择</option>
                        <option value="Class_ID">班级编号</option>
                        <option value="Class_Name">班级名</option>
                        <option value="Teacher_Name">班主任名称</option>
                      </select>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      ...
                      <td align="center">
                      <a href="TCManager.action?Class_ID=${Class_ID}">修改班主任</a>
                      <a href="ClassUpdate.action?Class_ID=${Class_ID}">修改</a> 
                      <a href="ClassDel.action?Class_ID=${Class_ID}" onClick="return confirm('确定要删除该班级的信息吗？')">删除</a>
                      </td>
                    </tr>
                  </s:iterator>
                </table></td>
