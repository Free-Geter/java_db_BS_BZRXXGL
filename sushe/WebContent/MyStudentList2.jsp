      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="MyStudentList2.action">
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="72%">查询：
                      ...
                      <input name="Class_ID" type="text" class="noshow" id="Class_ID" value="${Class_ID}"></td>
                  </tr>
                </table>
              </form>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="center"  class="t1">
                    ...
                    <td bgcolor="#D5E4F4"><strong>寝室评价</strong></td>
